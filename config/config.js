...
const config = {
    root: {
        publicUrl: `${process.env.ANCHR_PUBLIC_URL}/api`,
        publicShortlinkUrl: `${process.env.ANCHR_PUBLIC_URL}/s`,
        publicImageUrl: `${process.env.ANCHR_PUBLIC_URL}/i`,
        clientUrl: `${process.env.ANCHR_PUBLIC_URL}/`,
        root: rootPath,
        app: {
        ...
        shortlinkCollectionName: process.env.ANCHR_SHORTLINK_COLLECTION,
        imageCollectionName: process.env.ANCHR_IMAGE_COLLECTION,
        cron: {
            linkcheckUpdate: process.env.ANCHR_LINKCHECK_UPDATE_CRON,
            shortlinkCleanup: process.env.ANCHR_LINKCHECK_UPDATE_CRON,
        },
        ...
        mailSender: process.env.ANCHR_MAIL_SENDER,
        telegram: {
        ...
        smtp: {
            ...
            port: process.env.ANCHR_SMTP_PORT,
        ...
        mailwhale: {
            url: process.env.ANCHR_MAILWHALE_URL,
